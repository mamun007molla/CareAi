    ...
    <div className="min-h-screen flex bg-bg">
      ...
      {mobile && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="absolute inset-y-0 left-0 w-64 z-10">
      ...
      <div className="flex-1 lg:ml-64 flex flex-col min-h-screen">
        {/* Mobile header */}
        <header className="lg:hidden sticky top-0 z-20 flex items-center gap-3 px-4 py-3 bg-surface border-b border-surface-border">
          <button onClick={() => setMobile(true)} className="text-muted hover:text-text">
            <Menu size={20} />
          </button>
          <span className="font-bold text-text">CareAI</span>
          <span className="text-xs text-muted ml-1">Module 1</span>
        </header>
