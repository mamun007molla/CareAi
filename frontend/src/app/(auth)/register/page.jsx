...
export default function RegisterPage() {
  ...
  const roles = [
    { value: "ELDERLY",   label: "👴 Elderly Patient",  desc: "I am the patient" },
    { value: "CAREGIVER", label: "👨‍👩‍👧 Caregiver",       desc: "I monitor a patient" },
  ];
      ...
      <Card className="p-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <input className={ic} placeholder="Mamun" value={form.name} onChange={set("name")} />
          ...
          <div className="space-y-1.5">
            ...
            <input className={ic} type="tel" placeholder="01778..." value={form.phone} onChange={set("phone")} />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <input className={ic} type="password" placeholder="••••••••" value={form.confirmPassword} onChange={set("confirmPassword")} />
